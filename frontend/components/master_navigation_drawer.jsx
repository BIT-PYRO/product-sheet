...
const NAV_LINKS = [
  ...
  { href: '/enrol-workforce', label: 'Enroll Workforce', className: 'bg-trust-blue/10 border border-trust-blue text-deep-blue hover:bg-trust-blue/20' },
  { href: '/enrol-customer', label: 'Enroll Customer', className: 'bg-trust-blue/10 border border-trust-blue text-deep-blue hover:bg-trust-blue/20' },
